...
namespace Obvious.Soap.Editor
{
    public static class SoapEditorUtils
    {
        ...
        public static void ToggleFastPlayMode()
        {
            ...
            var text = EditorSettings.enterPlayModeOptionsEnabled ? $" <color=#55efc4>Enabled" : $"<color={SoapColorHtml}>Disabled";
            text += "</color>";
        ...
        /// <summary> Creates a new C# class from a template. </summary>
        /// <param name="templateName"></param>
        /// <param name="typeName"></param>
        /// <param name="fileName"></param>
        /// <param name="path"></param>
        public static TextAsset CreateNewClass(string templateName, string typeName, string fileName, string path)
        {
